...
export const AuthProvider = ({ children }) => {
    ...
    const getNotices = async () => {
        try {
            const response = await fetch("https://classroom-management-backend-one.vercel.app/api/data/shownotice", {
                method: "GET"
            });
            if (response.ok) {
    ...
    const getAllSubjects = async () => {
        try {
            const response = await fetch("https://classroom-management-backend-one.vercel.app/api/subject/showsubject", {
                method: "GET",
            });
            if (response.ok) {
                const data = await response.json();
    ...
    const getClass = async () => {
        try {
            const response = await fetch("https://classroom-management-backend-one.vercel.app/api/dispclass/showclass", {
                method: "GET"
            });
            if (response.ok) {
                const data = await response.json();
    ...
    const getStudent = async () => {
        try {
            const response = await fetch("https://classroom-management-backend-one.vercel.app/api/std/dispstudent", {
                method: "GET",
            });
            if (response.ok) {
                const data = await response.json();
    ...
    const getTeacher = async () => {
        try {
            const response = await fetch("https://classroom-management-backend-one.vercel.app/api/createteacher/dispteacher", {
                method: "GET",
            });
            if (response.ok) {
                const data = await response.json();            
    ...
    const getAllMarks = async () => {
        try {
            const response = await fetch("https://classroom-management-backend-one.vercel.app/api/marks/dispmarks", {
                method: "GET",
            });
            if (response.ok) {
                const data = await response.json();
    ...
    const userAuthentication = async () => {
        try {
            const response = await fetch("https://classroom-management-backend-one.vercel.app/api/auth/logindata", {
                method: "GET",
                headers: {
    ...
    const studentAuth = async () => {
        try {
            const response = await fetch("https://classroom-management-backend-one.vercel.app/api/std/authstudent", {
                method: "GET",
                headers: {
                    Authorization: `Bearer ${token}`
                },
    ...
    const numberStudent = async () => {
        try {
            const response = await fetch("https://classroom-management-backend-one.vercel.app/api/std/countstudent", {
                method: "GET",
            });
            if (response.ok) {
                const data = await response.json();
